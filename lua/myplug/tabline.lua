...
local lightgrey = C:getcolor('ql_lightgrey')
...
vim.api.nvim_create_autocmd('ColorScheme', {
	...
	callback = function()
		...
		hi(0, "ModeInsert", { fg = lightgrey, bg = green })
		hi(0, "ModeInsertRev", { reverse = true, fg = lightgrey, bg = green })
		hi(0, "ModeVisual", { fg = lightgrey, bg = orange })
		hi(0, "ModeVisualRev", { reverse = true, fg = lightgrey, bg = orange })
		hi(0, "ModeCmdline", { fg = lightgrey, bg = brighter_orange })
		hi(0, "ModeCmdlineRev", { reverse = true, fg = lightgrey, bg = brighter_orange })
		hi(0, "ModeReplace", { fg = lightgrey, bg = red })
		hi(0, "ModeReplaceRev", { reverse = true, fg = lightgrey, bg = red })
		hi(0, "ModeOperatorPending", { fg = lightgrey, bg = purple })
		hi(0, "ModeOperatorPendingRev", { reverse = true, fg = lightgrey, bg = purple })
		hi(0, "ModeTerminal", { fg = lightgrey, bg = black })
		hi(0, "ModeTerminalRev", { reverse = true, fg = lightgrey, bg = black })
	end
})
